...
class CommitInfo(Screen):
	def __init__(self, session):
		...
		self.project = 0
		self.projects = [
			("https://api.github.com/repos/linuxbox10/enigma2/commits" + branch, "Enigma2"),
			("https://api.github.com/repos/linuxbox10/vuplus-image-core/commits" + branch, "OpenTen Core"),
			...
			("https://api.github.com/repos/linuxbox10/Catseye/commits", "Catseye Settings"),
			("https://api.github.com/repos/linuxbox10/skin-PLiHD/commits", "Skin PLi HD"),
			("https://api.github.com/repos/E2OpenPlugins/e2openplugin-OpenWebif/commits", "OpenWebif"),
			("https://api.github.com/repos/linuxbox10/DirtyDonki-Settings/commits", "Dirty Donki settings")
		]
		self.cachedProjects = {}
		self.Timer = eTimer()
